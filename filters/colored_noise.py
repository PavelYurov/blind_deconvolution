"""
Функции генерации цветного шума.
...
def powerlaw_psd_gaussian(
    ...
    ---------
    exponent : float
        Экспонента шума S(f) = (1 / f)**beta.
        Розовый шум: beta = 1.
        Коричневый шум: beta = 2.
    size : Union[int, Iterable[int]]
        Размер выходной марицы.
    fmin : float
        Порог минимальной частоты от 0.0 до 0.5.
...
def pink_noise_2d(shape: Tuple[int, int], alpha: float = 1.0) -> np.ndarray:
    """
    ...
    ---------
    shape : Tuple[int, int]
        Размер выходного массива шума.
    alpha : float
        Экспонента 'a' 1/f^a шума.
