...
- **Байесовские и вариационные подходы методы**:
  ...
  - Вариационный байесовский вывод (Variational Bayesian Inference) и минимизация KL-дивергенции (ELBO)
- **Методы на основе статистики каналов и градиентов**:
  ...
  - Патч-ориентированные априоры минимальных пикселей (PMP) и локальные максимумы градиентов (LMGP)
  - Применение сглаживающей L0-нормы 
