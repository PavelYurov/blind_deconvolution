...
- **Разработка и имплементация алгоритмов восстановления изображений:** байесовские; вариацонные и отимизационные; тензорные
...
- **Классические методы**: Bussgang, LPA‑ICI, L0/L1‑регуляризация
- **Байесовские методы**:
