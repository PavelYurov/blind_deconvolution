"""
JeffreysblakeFunsearchBlindDeconvolution - Python Wrapper

Original Implementation:
    jeffreysblake (GitHub)
    GitHub Repository: https://github.com/jeffreysblake/funsearch-blind-deconvolution
...
Example:
    >>> from my_wrappers import JeffreysblakeFunsearchBlindDeconvolution
    >>> processor = JeffreysblakeFunsearchBlindDeconvolution()
