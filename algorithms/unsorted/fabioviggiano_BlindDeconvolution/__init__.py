"""
FabioviggianoBlindDeconvolution - Python Wrapper

Original Implementation:
    fabioviggiano (GitHub)
    GitHub Repository: https://github.com/fabioviggiano/BlindDeconvolution
...
Example:
    >>> from my_wrappers import FabioviggianoBlindDeconvolution
    >>> processor = FabioviggianoBlindDeconvolution()
