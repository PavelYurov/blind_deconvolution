"""
DrorharushSBD - Python Wrapper

Original Implementation:
    Drorharush (GitHub)
    GitHub Repository: https://github.com/Drorharush/SBD
...
Example:
    >>> from my_wrappers import DrorharushSBD
    >>> processor = DrorharushSBD()
