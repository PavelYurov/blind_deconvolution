"""
GeekLoganPyBlindRL - Python Wrapper

Original Implementation:
    GeekLogan (GitHub)
    GitHub Repository: https://github.com/GeekLogan/pyBlindRL
...
Example:
    >>> from my_wrappers import GeekLoganPyBlindRL
    >>> processor = GeekLoganPyBlindRL()
