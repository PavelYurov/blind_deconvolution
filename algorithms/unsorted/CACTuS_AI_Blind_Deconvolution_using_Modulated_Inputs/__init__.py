"""
CACTuSAIBlindDeconvolutionUsingModulatedInputs - Python Wrapper

Original Implementation:
    CACTuS-AI (GitHub)
    GitHub Repository: https://github.com/CACTuS-AI/Blind-Deconvolution-using-Modulated-Inputs
...
Example:
    >>> from my_wrappers import CACTuSAIBlindDeconvolutionUsingModulatedInputs
    >>> processor = CACTuSAIBlindDeconvolutionUsingModulatedInputs()
