"""
VipgugrBCDSAR - Python Wrapper

Original Implementation:
    vipgugr (GitHub)
    GitHub Repository: https://github.com/vipgugr/BCDSAR
...
Example:
    >>> from my_wrappers import VipgugrBCDSAR
    >>> processor = VipgugrBCDSAR()
