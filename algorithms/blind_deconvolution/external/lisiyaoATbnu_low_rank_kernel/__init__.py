"""
LisiyaoATbnuLowRankKernel - Python Wrapper

Original Implementation:
    lisiyaoATbnu (GitHub)
    GitHub Repository: https://github.com/lisiyaoATbnu/low_rank_kernel
...
Example:
    >>> from my_wrappers import LisiyaoATbnuLowRankKernel
    >>> processor = LisiyaoATbnuLowRankKernel()
