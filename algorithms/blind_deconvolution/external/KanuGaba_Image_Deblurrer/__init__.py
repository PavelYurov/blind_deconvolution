"""
KanuGabaImageDeblurrer - Python Wrapper

Original Implementation:
    KanuGaba (GitHub)
    GitHub Repository: https://github.com/KanuGaba/Image-Deblurrer/
...
Example:
    >>> from my_wrappers import KanuGabaImageDeblurrer
    >>> processor = KanuGabaImageDeblurrer()
