"""
YoungforgithubL0TextDeblurring - Python Wrapper

Original Implementation:
    Youngforgithub (GitHub)
    GitHub Repository: https://github.com/Youngforgithub/Deblurring-Text-Images-via-L0-Regularized-Intensity-and-Gradient
    Language/Framework: MATLAB

Reference Paper (if applicable):
    the image deblurring algorithm described in the paper:

Algorithm Description:
    - L0 regularization on intensity/gradients (useful for text images)
...
Example:
    >>> from my_wrappers import YoungforgithubL0TextDeblurring
    >>> processor = YoungforgithubL0TextDeblurring()
...
Original Author: Youngforgithub
