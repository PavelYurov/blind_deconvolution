"""
Dragos2001TotalVariationBlindDeconvolution - Python Wrapper

Original Implementation:
    dragos2001 (GitHub)
    GitHub Repository: https://github.com/dragos2001/Total_Variation_Blind_Deconvolution
    Language/Framework: Python

Reference Paper (if applicable):
    a Total Variation Deconvoltuion Algorithm.

Algorithm Description:
    - Total-variation (TV) regularization to suppress ringing/noise
...
Example:
    >>> from my_wrappers import Dragos2001TotalVariationBlindDeconvolution
    >>> processor = Dragos2001TotalVariationBlindDeconvolution()
