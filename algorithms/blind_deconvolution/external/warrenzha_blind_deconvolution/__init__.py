"""
WarrenzhaBlindDeconvolution - Python Wrapper

Original Implementation:
    warrenzha (GitHub)
    GitHub Repository: https://github.com/warrenzha/blind-deconvolution
...
Example:
    >>> from my_wrappers import WarrenzhaBlindDeconvolution
    >>> processor = WarrenzhaBlindDeconvolution()
