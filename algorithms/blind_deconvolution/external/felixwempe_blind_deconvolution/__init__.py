"""
FelixwempeBlindDeconvolution - Python Wrapper

Original Implementation:
    felixwempe (GitHub)
    GitHub Repository: https://github.com/felixwempe/blind_deconvolution/
...
Example:
    >>> from my_wrappers import FelixwempeBlindDeconvolution
    >>> processor = FelixwempeBlindDeconvolution()
