"""
CeciledellavalleBlindDeconvolution - Python Wrapper

Original Implementation:
    ceciledellavalle (GitHub)
    GitHub Repository: https://github.com/ceciledellavalle/BlindDeconvolution
...
Example:
    >>> from my_wrappers import CeciledellavalleBlindDeconvolution
    >>> processor = CeciledellavalleBlindDeconvolution()
...
Original Author: ceciledellavalle
