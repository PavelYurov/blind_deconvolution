"""
Qingqu06MCSBD - Python Wrapper

Original Implementation:
    qingqu06 (GitHub)
    GitHub Repository: https://github.com/qingqu06/MCS-BD
...
Example:
    >>> from my_wrappers import Qingqu06MCSBD
    >>> processor = Qingqu06MCSBD()
