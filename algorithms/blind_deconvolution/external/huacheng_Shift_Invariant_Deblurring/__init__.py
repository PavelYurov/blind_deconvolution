"""
HuachengShiftInvariantDeblurring - Python Wrapper

Original Implementation:
    huacheng (GitHub)
    GitHub Repository: https://github.com/huacheng/Shift-Invariant-Deblurring
...
Example:
    >>> from my_wrappers import HuachengShiftInvariantDeblurring
    >>> processor = HuachengShiftInvariantDeblurring()
