"""
MaxMBImageRestorationWienerBlind - Python Wrapper

Original Implementation:
    MaxMB (GitHub)
    GitHub Repository: https://github.com/MaxMB/Image_Restoration_Wiener_Blind
...
Algorithm Description:
    - Wiener-style deconvolution with iterative blind kernel refinement
...
Example:
    >>> from my_wrappers import MaxMBImageRestorationWienerBlind
    >>> processor = MaxMBImageRestorationWienerBlind()
