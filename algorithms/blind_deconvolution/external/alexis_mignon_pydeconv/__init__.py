"""
AlexisMignonPydeconv - Python Wrapper

Original Implementation:
    alexis-mignon (GitHub)
    GitHub Repository: https://github.com/alexis-mignon/pydeconv
...
Example:
    >>> from my_wrappers import AlexisMignonPydeconv
    >>> processor = AlexisMignonPydeconv()
