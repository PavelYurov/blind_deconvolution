"""
CrewleaderBlindDeconvolutionLowRank - Python Wrapper

Original Implementation:
    crewleader (GitHub)
    GitHub Repository: https://github.com/crewleader/BlindDeconvolutionLowRank
...
Algorithm Description:
    - Low-rank constraint/prior for kernel estimation
...
Example:
    >>> from my_wrappers import CrewleaderBlindDeconvolutionLowRank
    >>> processor = CrewleaderBlindDeconvolutionLowRank()
