"""
ZalteckBCDTV - Python Wrapper

Original Implementation:
    zalteck (GitHub)
    GitHub Repository: https://github.com/zalteck/BCDTV
...
Example:
    >>> from my_wrappers import ZalteckBCDTV
    >>> processor = ZalteckBCDTV()
