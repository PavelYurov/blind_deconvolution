...
from filters.distributions import (
    ...
    linear_decay_distribution,
    ring_distribution,
    uniform_distribution,
)
from filters.blur import DefocusBlur, MotionBlur
from filters.noise import GaussianNoise, PoissonNoise, SaltAndPepperNoise


class Generator:
    def __init__(
        self, input_dir="HR", output_dir="filtered", kernel_dir="kernel for bluring"
    ):
        ...
        self.blur_configs = [
            {
                "name": "defocus_gaussian",
                "class": DefocusBlur,
                "params": {"psf": gaussian_distribution, "param": 8.0},
            },
            {
                "name": "defocus_disk",
                "class": DefocusBlur,
                "params": {"psf": uniform_distribution, "param": 10.0},
            },
            {
                "name": "defocus_cone",
                "class": DefocusBlur,
                "params": {"psf": linear_decay_distribution, "param": 12.0},
            },
            {
                "name": "defocus_ring",
                "class": DefocusBlur,
                "params": {"psf": ring_distribution, "param": 9.0},
            },
            {
                "name": "motion_linear_uniform",
                "class": MotionBlur,
                "params": {"psf": uniform_distribution, "param": 15.0, "angle": 30},
            },
            {
                "name": "motion_linear_exp",
                "class": MotionBlur,
                "params": {
...
processor = Generator(
    input_dir="HR", output_dir="filtered", kernel_dir="kernel for bluring"
)
