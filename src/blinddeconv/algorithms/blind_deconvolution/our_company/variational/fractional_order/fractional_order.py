...
class FractionalOrderPMPDeconv(DeconvolutionAlgorithm):
    """Blind deconvolution via PMP prior + fractional-order TV.
    """
    ...
    def __init__(
        ...
        hysteresis_ratio: float = 0.5, # New: Ratio low/high for hysteresis
        border_width: int = 5,      
        boundary_mode: str = 'pad', 
        
        patch_size: int = 3,
        
        final_restoration_mode: Optional[str] = None, # 'tikhonov', 'richardson', None
