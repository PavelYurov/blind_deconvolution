...
Алгоритмы могут вызываться на разных стадиях работы:
...
Если алгоритму требуется оценка дисперсии шума и она не передана в параметрах 
явно (через sigma, sigma_color, sigma_psd или noise_var), значение вычисляется 
автоматически по входному изображению.
"""
