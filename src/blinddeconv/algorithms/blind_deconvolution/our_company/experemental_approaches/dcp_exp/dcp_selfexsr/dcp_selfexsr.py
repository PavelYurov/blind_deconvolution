...
Parameters unique to this variant (vs. original DCP):
    ...
    sr_num_iter      — PatchMatch iterations in SelfExSR (default 3)
    sr_n_iter_bp     — back-projection iterations in SelfExSR (default 5)
    ...
    wiener_snr       — Wiener filter SNR for initial deblur (default 0.05)
    sr_downscale     — resolution factor for SR input (default 0.75)
"""
...
class DCP_SelfExSR_BD(DeconvolutionAlgorithm):
    ...
    sr_num_iter      : int — PatchMatch iterations for SelfExSR (default 3).
    sr_n_iter_bp     : int — back-projection iterations for SelfExSR (default 5).
    ...
    wiener_snr       : float — Wiener filter SNR for the initial deblur
                       before SR.  Higher = more conservative.  (default 0.05).
    sr_downscale     : float — resolution factor for the image passed to
                       SelfExSR.  0.75 = 75% resolution (≈1.8× faster).
                       (default 0.75).
    """
