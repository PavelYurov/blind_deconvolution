...
# ОБЩИЕ НАСТРОЙКИ
# ══════════════════════════════════════════════════════════════════════════════
ALGORITHM_LABEL = "Dark Channel Prior (Base)"
...
ALG_MODULE = "src.blinddeconv.algorithms.blind_deconvolution.our_company.dark_channel_prior.dcp_cython.dcp"
ALG_CLASS  = "DCP_BD"
...
ALG_MODULE_DENOISE = ("src.blinddeconv.algorithms.blind_deconvolution."
                        "our_company.dark_channel_prior."
...
ALG_KWARGS = {
    ...
    # 'pre_nonblind':'bm3d',
    # 'blind_hooks':{
    # 'latent_denoise': 'guided',    # bilateral/guided/tv/nlm/bm3d/act
    # 'latent_denoise_params': {'radius': 4, 'eps': 0.01},
    # 'latent_denoise_decay': 0.9,   # ослабляем денойзинг с итерациями
    # 'grad_eq': 'none',            # эквализация ТОЛЬКО для градиентов
    # 'grad_eq_params': {'clip_limit': 0.01},
    # 'kernel_smooth': 'gaussian',   # сглаживание ядра
    # 'kernel_smooth_params': {'sigma': 0.5},}
}
