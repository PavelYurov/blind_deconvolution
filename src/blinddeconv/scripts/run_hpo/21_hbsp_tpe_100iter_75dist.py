...
PARETO_OUTPUT_DIR = HPO_RL_ROOT / "21_hbsp_tpe_100iter_75dist"
...
def _plot_pareto_3d_with_points_nd(
    ...
    if len(pareto_pts) >= 4:
        try:
            ...
            print(f"  [Warning] Ошибка построения ND поверхности: {e}")
...
def _build_interactive_figure_nd(
    ...
    if len(pareto_pts) >= 4:
        try:
            ...
            print(f"  [Warning] Ошибка построения интерактивной ND поверхности: {e}")
...
def _build_interactive_figure(
    ...
    if len(pareto_pts) >= 4:
        try:
            ...
            print(f"  [Warning] Ошибка построения интерактивной поверхности: {e}")
