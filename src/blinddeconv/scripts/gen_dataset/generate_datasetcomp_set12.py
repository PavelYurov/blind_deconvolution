...
INPUT_ORIGINALS_DIR = FRAMEWORK_ROOT / "images" / "compare_data" / "Set12" / "originals"
INPUT_KERNELS_DIR   = FRAMEWORK_ROOT / "images" / "compare_data" / "Set12" / "ground_truth_filters"

# 2. Куда сохраняем готовый датасет
OUTPUT_DATASET_DIR  = FRAMEWORK_ROOT / "images" / "compare_data" / "Set12"
