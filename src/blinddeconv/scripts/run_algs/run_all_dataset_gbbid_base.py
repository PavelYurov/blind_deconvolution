...
ALGORITHM_LABEL = "Reweighted Graph TV (Base)"
...
# ══════════════════════════════════════════════════════════════════════════════
ALG_KWARGS = {
    'k_estimate_size': 51,                  # будет адаптирован под GT ядро
    'border': 20,
}


# ══════════════════════════════════════════════════════════════════════════════
# ФАЗА 1: ПОСЧЕТ НА ДАТАСЕТАХ
# ══════════════════════════════════════════════════════════════════════════════
...
def run_phase1_datasets():
    ...
    for dataset_name in DATASETS_PHASE1:
        ...
        # Complexity_Test: несколько родсчетов для стабильного времени
