...
ALGORITHM_CONFIGS: list[dict[str, Any]] = [
    {
        ...
        "alg_module":       ("src.blinddeconv.algorithms.blind_deconvolution."
                             "our_company.bayesian.fbdhsgp.fbdhsgp_cython."
                             "_build_pyd.fbdhsgp"),
        "alg_class":        "FBDHSGP",
        ...
        "standard_kwargs": {
            ...
            "final_nb":           "frils",
            "auto_mode_params":   {"correlated_use_act_preblind": False,
                                   "correlated_check":            False},
            "kernel_threshold":   0.05,
        },
        "pareto_tables_dir":
            PROJECT_ROOT / "presentation_graphics_pareto"
            / "pareto_15_fbdhsgp_tpe_150iter_50dist",
        "int_keys":     ["kernel_size", "K1", "xh_iter", "h_iter"],
        "odd_keys":     ["kernel_size"],
        "tunable_keys": ["kernel_size", "sigma", "epsilon_min", "beta_v",
                         "prior_alpha", "K1", "xh_iter", "h_iter",
                         "delta", "delta_x"],
        ...
        "history_path": (
            PROJECT_ROOT / "presentation_graphics_pareto"
            / "pareto_15_fbdhsgp_tpe_150iter_50dist"
            / "logs" / "TPE" / "20260502_102307" / "history_0.csv"
        ),
    },
]
