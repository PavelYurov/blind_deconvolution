...
ALGORITHM_LABEL = "Patch-wise Min Pixels (Base)"
...
# Модуль алгоритма
ALG_MODULE = "src.blinddeconv.algorithms.blind_deconvolution.our_company.patch_wise_minimum_pixels_prior.pmp_cython._build_pyd.pmp"
ALG_CLASS  = "PMP_BD"
...
GRID_PARAM_1 = "lambda_pmp"
GRID_VALUES_1 = [1e-3, 3e-3, 1e-2, 3e-2, 1e-1, 3e-1, 1.0]
