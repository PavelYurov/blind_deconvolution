...
ALGORITHM_LABEL = "Logarithmic-TV MM (GD)"
...
ALG_KWARGS = {
    ...
    'final_deconv': 'auto',
    'auto_mode': 'robust',
    'nb_params': {'blend_weight': 0.5, 'lambda_tv': 0.005, 'lambda_l0': 0.002},
...
GRID_PARAM_1 = "lambda_val"
GRID_VALUES_1 = [5e3, 1e4, 2e4, 3e4, 5e4, 1e5]

GRID_PARAM_2 = "tau"
GRID_VALUES_2 = [1e-4, 3e-4, 1e-3, 2e-3, 5e-3]
