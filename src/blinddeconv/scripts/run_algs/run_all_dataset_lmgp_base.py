...
ALGORITHM_LABEL = "Local Max Gradient (Base)"
...
ALG_MODULE = ("src.blinddeconv.algorithms.blind_deconvolution."
              "our_company.lmgp.lmgp_cython._build_pyd.lmgp")
ALG_CLASS  = "LMGP_BD"
...
def _make_nonblind_func(alg_kwargs):
    ...
    from src.blinddeconv.algorithms.blind_deconvolution.our_company.\
        lmgp.lmgp_denoise.solvers import ringing_artifacts_removal
