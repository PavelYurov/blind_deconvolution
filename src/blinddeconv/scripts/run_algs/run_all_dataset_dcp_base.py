...
NUM_WORKERS = 8  # Количество процессов для параллельного подсчета датасетов
...
# Модуль алгоритма
ALG_MODULE = "src.blinddeconv.algorithms.blind_deconvolution.our_company.dark_channel_prior.dcp_cython._build_pyd.dcp"
ALG_CLASS  = "DCP_BD"
...
def run_phase3_hyperparam_grid():
    ...
    for dist_file in distorted_files:
        ...
        print(f"\n  [{stem}] Подсчетов {len(combos)} комбинаций...")
